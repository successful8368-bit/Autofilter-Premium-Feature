...
API_ID = int(environ.get('31676249', '0')) # API ID from my.telegram.org
API_HASH = environ.get('69d62c78c6408929acc40fb77a644366', '')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('8442436987:AAGHJeaufgg91SQzEhviSpvy0LTdq_yO2dc', "")    # Bot token from @BotFather
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('7967089292', '').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003703783457').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003703783457'))  # Log channel id (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('mongodb+srv://zulisharma123:<db_password>@cluster0.idslk8d.mongodb.net/?appName=Cluster0', "")  # MongoDB URI for the database
DATABASE_NAME = environ.get('Cluster0', "Cluster0") # Database name (default: cluster)
